...
function clickHandler(event) {
    ...
    if (target.classList.contains('digit') || target.classList.contains('operation') || target.classList.contains('bracket')) {
        screen.textContent == "0"?  screen.textContent = "" : console.log(111);
        screen.textContent += value;
        if(screen.textContent.length > 10) screen.textContent = screen.textContent.substring(0,10);
...
function clickHandler(event) {
    ...
    if (target.classList.contains('digit') || target.classList.contains('bracket')) {
        screen.textContent == "0"?  screen.textContent = "" : console.log(111);
        screen.textContent += value;
        if(screen.textContent.length > 12) screen.textContent = screen.textContent.substring(0,12);
